...
const steps = [
  {
    ...
    description:
      "The extension comes pre-loaded with 36+ providers automatically! Default provider data (NPIs, DEAs, emails, addresses, and more) is included when you install. You can also add more providers by importing a CSV file or manually entering them through the extension&apos;s form. The extension stores everything locally — names, NPIs, DEA numbers, addresses, education, credentials, all 80+ fields.",
    icon: (
